...
public class SLTCKLanguageProvider implements LanguageProvider {
    ...
    public Collection<? extends Snippet> createScripts(Context context) {
        final Collection<Snippet> res = new ArrayList<>();
        res.add(loadScript(context, "resources/Ackermann.dart", TypeDescriptor.NULL, null));
        res.add(loadScript(context, "resources/Fibonacci.dart", TypeDescriptor.NULL, null));
        return Collections.unmodifiableCollection(res);
    }
    ...
    public Collection<? extends Source> createInvalidSyntaxScripts(Context context) {
        try {
            ...
            res.add(createSource("resources/InvalidSyntax01.dart"));
            res.add(createSource("resources/InvalidSyntax02.dart"));
            return Collections.unmodifiableCollection(res);
